...
// import download1 from '../../assets/landing_page/download (1).png';
// import download2 from '../../assets/landing_page/download (2).png';
...
//           <div className="absolute inset-0 bg-cover bg-center opacity-100 scale-110 rounded-[40px]" style={{ backgroundImage: `url(${download2})` }}></div>
//           <img
//             src={tubularLetters}
//             alt="Pool Party"
...
//         <div className="absolute inset-0 bg-cover bg-center opacity-100 scale-110 rounded-[40px]" style={{ backgroundImage: `url(${download1})` }}></div>
...
//         <div className="relative flex gap-8 bg-cover bg-center opacity-100 scale-110 rounded-[30px] p-10 shadow-xl" style={{ backgroundImage: `url(${download1})` }}>
//           {/* Stars */}
...
const DigitalInvites = () => {
  return (
    <div className="bg-[#fdf6f9] mt-[-120px] mb-[-200px]  flex flex-col items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      {/* Heading Section */}
      <div className="text-center">
        <h1 className="text-4xl font-extrabold text-black sm:text-5xl md:text-6xl">
          Animated <span className="text-pink-600">Digital Invites</span><br></br> by EazyInvites
        </h1>
        <p className="mt-4 text-lg text-gray-600">
          The world's first web-based animated wedding invitations with RSVP functionality and AI-powered photo sharing.
        </p>
      </div>
      ...
      <div className="mt-8">
        <a
          href="#"
          className="inline-block px-6 py-3 text-white bg-pink-600 hover:bg-pink-700 font-semibold rounded-lg shadow-lg transition duration-200"
        >
          View Designs
        </a>
      </div>
...
const Carousel = () => {
  ...
  return (
    <div className="flex h-screen w-full bg-[#fdf6f9] animate-[fadeIn_0.6s_ease-out]" style={{ animation: 'fadeIn 0.6s ease-out both' }}>
      {/* Carousel Section */}
      <div className="flex-1 relative bg-[#fdf6f9] overflow-hidden flex items-center justify-center ">
        <div className="relative flex items-center justify-center top-[-115px]">
          {/* Left Arrow */}
          <button
            className="absolute left-[-240px] top-1/2 -translate-y-1/2 z-20 bg-white border-none text-2xl cursor-pointer p-3 rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.3)] transition-colors duration-300 flex items-center justify-center text-[#333] select-none hover:bg-gray-100"
            onClick={prevSlide}
          >
            <FaChevronLeft />
          </button>
          ...
          {/* Carousel Images */}
          <div className="relative w-[260px] h-[480px] flex items-center justify-center md:w-[260px] md:h-[460px]">
            {images.map((img, index) => {
              let position = "nextSlide";
              if (index === current) {
                position = "activeSlide";
              } else if (index === current - 1 || (current === 0 && index === images.length - 1)) {
                position = "lastSlide";
              }

              let positionClasses = "absolute w-[260px] h-[480px] object-cover rounded-[40px] shadow-[0_8px_20px_rgba(0,0,0,0.2)] transition-all duration-500 z-10 opacity-0 scale-80";

              if (position === "activeSlide") {
                positionClasses = "top-2.5 absolute w-[250px] h-[550px] object-cover rounded-[35px] shadow-[0_8px_20px_rgba(0,0,0,0.2)] transition-all duration-600 opacity-100 scale-100 z-20";
              } else if (position === "lastSlide") {
                positionClasses = "top-2.5 right-32 absolute w-[250px] h-[550px] object-cover rounded-[35px] shadow-[0_8px_20px_rgba(0,0,0,0.2)] transition-all duration-600 opacity-60 -translate-x-[120px] scale-[0.85] z-10";
              } else if (position === "nextSlide") {
                positionClasses = "top-2.5 left-32 absolute w-[250px] h-[550px] object-cover rounded-[35px] shadow-[0_8px_20px_rgba(0,0,0,0.2)] transition-all duration-600 opacity-60 translate-x-[120px] scale-[0.85] z-10";
              }
            ...
            {/* Phone Frame */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[280px] h-[520px] z-10 pointer-events-none">
              <img
                src="https://framerusercontent.com/images/YlYIbfFEujexwgWABDzpsRlY.webp?scale-down-to=1024"
                alt="Phone Frame"
          ...
          {/* Right Arrow */}
          <button
            className="absolute right-[-240px] top-1/2 -translate-y-1/2 z-20 bg-white border-none text-2xl cursor-pointer p-3 rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.3)] transition-colors duration-300 flex items-center justify-center text-[#333] select-none hover:bg-gray-100"
            onClick={nextSlide}
          >
            <FaChevronRight />
          </button>
...
const ReviewSlider = () => {
  ...
  return (
    <section className="py-1 px-10 bg-[#fdf6f9] text-center font-sans">
      <h2 className="text-4xl font-semibold mb-10 text-gray-900">
...
const WeddingInvites = () => {
  const [current, setCurrent] = useState(0);
  const images = [phoneImage4, phoneImage5];
  ...
  return (
    <div className="bg-[#fdf6f9] py-20 px-4 sm:px-6 lg:px-8">
      {/* Heading Section */}
      <div className="text-center mb-10">
        <h1 className="text-xl font-extrabold text-black sm:text-5xl md:text-4xl">
          Explore Our Remarkable Assortment of <br className="hidden sm:block" />
      ...
      <div className="relative flex items-center justify-center">
        ...
        <button
          onClick={prevSlide}
          className="absolute left-[-60px] sm:left-[100px] top-1/2 transform -translate-y-1/2 text-2xl text-gray-700 hover:bg-gray-200 rounded-full p-3 shadow-md"
        >
          <FaChevronLeft />
        </button>
        ...
        <div className="relative flex items-center justify-center space-x-4">
          {images.map((img, index) => {
            ...
            let positionClasses = "w-[560px] h-[480px] object-cover rounded-[40px] shadow-xl transition-transform duration-500 scale-90 opacity-100";

            if (position === "activeSlide") {
              positionClasses = "w-[560px] h-[480px] object-cover rounded-[40px] shadow-xl transition-transform duration-500 scale-90 opacity-100";
            }

            return (
              <div key={index} className={`${positionClasses} transition-all`}>
                <img src={img} alt={`Template ${index + 1}`} className="w-full h-full object-cover rounded-[40px]" />
              </div>
            );
          })}
        </div>
        ...
        <button
          onClick={nextSlide}
          className="absolute right-[-60px] sm:right-[100px] top-1/2 transform -translate-y-1/2 text-2xl text-gray-700 hover:bg-gray-200 rounded-full p-3 shadow-md"
        >
          <FaChevronRight />
        </button>
      </div>
      ...
      {/* Description Text */}
      <div className="absolute bottom-[-40px] sm:bottom-[-60px] text-center w-full">
        <p className="text-xl text-gray-800">Summer Breeze</p>
        <p className="text-md text-gray-600">Refreshing and vibrant like sunny days</p>
      </div>
    </div>
  );
};
